...
## Результаты
### Использовалось по 5 сабсетов из каждого датасета
| Модель                                  | Размер (MB) | MMLU accuracy (NUM_SUBSET=5) | Compression ratio | Score  |
|-----------------------------------------|-------------|------------------------------|-------------------|----------------|
| Оригинальная (Qwen3-8B, FP16)           | 15622.588135     | 0.657895                   | 1.00×             | —              |
| Квантизованная (4-bit NF4 + double quant) | 5686.588135      | 0.654971                   | 2.747269             | 2.735113       |
| После QLoRA fine-tuning (raler/qwen3-8b-qlora-finetuned1) | 5920.588135      | 0.654971                       | 2.638688             | 2.627013              |