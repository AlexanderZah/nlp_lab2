...
| Модель                                  | Размер (MB) | MMLU accuracy | Compression ratio | Score  |
|-----------------------------------------|-------------|------------------------------|-------------------|----------------|
| Оригинальная (Qwen3-8B, FP16)           | 15622.59     | 0.6579                   | 1.00×             | —              |
| Квантизованная (4-bit NF4 + double quant) | 5686.59      | 0.6550                   | 2.75             | 2.74       |
| После QLoRA fine-tuning (raler/qwen3-8b-qlora-finetuned1) | 5920.58      | 0.6550                       | 2.64             | 2.63              |